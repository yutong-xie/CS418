...
var eyePt = vec3.fromValues(0.0,0.05,-0.7);
/** @global Direction of the view in world coordinates */
var viewDir = vec3.fromValues(0.0,-0.1,-1.0);
/** @global Up vector for view matrix creation, in world coordinates */
var up = vec3.fromValues(0.0,1.0,0.5);
...
function setupBuffers() {
    myTerrain = new Terrain(70,-0.5,0.5,-0.5,0.5);
...
function draw() {
    ...
    //Draw Terrain
    mvPushMatrix();
    vec3.set(transformVec,0.0,-0.2,-2.0);
