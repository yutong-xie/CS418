    ...
    */
    loadFromOBJ(fileText)
    {
        ...
        for(var i=0; i<lines.length; i++) {
            ...
            if(lines[i][0] == "v") {
                this.vBuffer.push(parseFloat(words[1]));
                this.vBuffer.push(parseFloat(words[2]));
                this.vBuffer.push(parseFloat(words[3]));
                this.numVertices++;
            }
            if(lines[i][0] == "f") {
                this.fBuffer.push(parseInt(words[2]) - 1);
                this.fBuffer.push(parseInt(words[3]) - 1);
                this.fBuffer.push(parseInt(words[4]) - 1);
                this.numFaces++;
            }
        }
